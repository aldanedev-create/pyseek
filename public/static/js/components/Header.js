...
const __component = {
  ...
  props: {"documents": {"type": "Number", "required": false, "default": null, "validator": null}},

  template: `<header class="topbar"><a class="brand" href="/" aria-label="PySeek home"><span class="logo">P</span><span>PySeek</span></a><span class="index-count">{{ documents || 0 }}indexed pages</span></header>`,
};
...
const __template = "<header class=\"topbar\"><a class=\"brand\" href=\"/\" aria-label=\"PySeek home\"><span class=\"logo\">P</span><span>PySeek</span></a><span class=\"index-count\">{{ documents || 0 }}indexed pages</span></header>";
const __style = "";
...
const __installStyle = () => {
  ...
  const styleId = "teloce-style-bf50d5e66";
